...
題目連結：[LeetCode 641 - Design Circular Deque](https://leetcode.com/problems/design-circular-deque/description/)

## 題目總結

設計可從前後端插入刪除的固定容量循環雙端佇列。

## 關鍵技巧

- 用 head 指向前端、count 記錄元素數；前端插入時 head 往前移，後端索引用公式取得。
